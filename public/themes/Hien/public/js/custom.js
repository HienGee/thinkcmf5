...
jQuery(document).ready(function($) {
	...
	if ( $.isFunction($.fn.backstretch) ) {
		$(".slider-wrapper").backstretch(["/themes/Hien/public/images/slider/slide-wrapper.jpg"]);
		if (window.devicePixelRatio >= 2) {
			$("section.blur,.slug .overlay").backstretch(["/themes/Hien/public/images/design/video-section-bg-retina.jpg"]);
			$(".slug .overlay,section.fixed .overlay").backstretch(["/themes/Hien/public/images/design/video-section-bg-opac-retina.png"]);
		} else {
			$("section.blur,.slug .overlay").backstretch(["/themes/Hien/public/images/design/video-section-bg.jpg"]);
			$(".slug .overlay,section.fixed .overlay").backstretch(["/themes/Hien/public/images/design/video-section-bg-opac.png"]);
		}
	}
